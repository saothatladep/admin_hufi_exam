...
export const SUBJECT_LIST_ALL_REQUEST = 'SUBJECT_LIST_ALL_REQUEST'
export const SUBJECT_LIST_ALL_SUCCESS = 'SUBJECT_LIST_ALL_SUCCESS'
export const SUBJECT_LIST_ALL_FAIL = 'SUBJECT_LIST_ALL_FAIL'
