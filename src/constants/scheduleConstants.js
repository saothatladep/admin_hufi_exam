...
export const SCHEDULE_LIST_ALL_REQUEST = 'SCHEDULE_LIST_ALL_REQUEST';
export const SCHEDULE_LIST_ALL_SUCCESS = 'SCHEDULE_LIST_ALL_SUCCESS';
export const SCHEDULE_LIST_ALL_FAIL = 'SCHEDULE_LIST_ALL_FAIL';
